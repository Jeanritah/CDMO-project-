# TODOS
- [ ] check how to save time/capture messages from the solver when result is
    - [ ] UNKNOWN
    - [ ] UNSAT
- [ ] connect run_cp to main method, pay attention to manage well all the optional arguments
